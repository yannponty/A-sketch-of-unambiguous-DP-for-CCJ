...
\newcommand{\PKnones}{\PKnone^s}
\newcommand {\pki}[3]{\PKnone^{i}(#1,#2,#3)}
\newcommand {\pks}[4]{\PKnone^s(#1,#2,#3,#4)}

\newcommand{\PXnone}{P_{X}}
\newcommand {\PX}[4]{\PXnone(#1,#2,#3,#4)}
\newcommand{\PXnones}{\PXnone^s}
\newcommand {\PXi}[3]{\PXnone^i(#1,#2,#3)}

\newcommand{\PLnone}{P_{\text{L}}}
\newcommand {\PL}[4]{\PLnone(#1,#2,#3,#4)}
\newcommand{\PLnones}{\PLnone^s}
\newcommand {\PLi}[3]{\PLnone^i(#1,#2,#3)}

\newcommand{\PRnone}{P_{\text{R}}}
\newcommand {\PR}[4]{\PRnone(#1,#2,#3,#4)}
\newcommand{\PRnones}{\PRnone^s}
\newcommand {\PRi}[3]{\PRnone^i(#1,#2,#3)}

\newcommand{\PMnone}{P_{\text{M}}}
\newcommand {\PM}[4]{\PMnone(#1,#2,#3,#4)}
\newcommand{\PMnones}{\PMnone^s}
\newcommand {\PMi}[3]{\PMnone^i(#1,#2,#3)}

\newcommand{\POnone}{P_{\text{O}}}
\newcommand {\PO}[4]{\POnone(#1,#2,#3,#4)}
\newcommand{\POnones}{ \POnone^s}
\newcommand {\POi}[3]{\POnone^i(#1,#2,#3)}

\newcommand{\PfromLnone}{P_{\text{fromL}}}
\newcommand {\PfromL}[4]{PfromLnone(#1,#2,#3,#4)}
\newcommand{\PfromLnones}{ PfromLnone^s}
\newcommand {\PfromLi}[3]{PfromLnone^i(#1,#2,#3)}

\newcommand{\PfromRnone}{P_{\text{fromR}}}
\newcommand {\PfromR}[4]{P_{\text{fromR}}(#1,#2,#3,#4)}
\newcommand{\PfromRnones}{ P_{\text{fromR}}^s}
\newcommand {\PfromRi}[3]{P_{\text{fromR}}^i(#1,#2,#3)}

\newcommand{\PfromMnone}{P_{\text{fromM}}}
\newcommand {\PfromM}[4]{P_{\text{fromM}}(#1,#2,#3,#4)}
\newcommand{\PfromMnones}{ P_{\text{fromM}}^s}
\newcommand {\PfromMi}[3]{P_{\text{fromM}}^i(#1,#2,#3)}

\newcommand{\PfromOnone}{P_{\text{fromO}}}
\newcommand {\PfromO}[4]{P_{\text{fromO}}(#1,#2,#3,#4)}
\newcommand{\PfromOnones}{ P_{\text{fromO}}^s}
\newcommand {\PfromOi}[3]{P_{\text{fromO}}^i(#1,#2,#3)}
...
Note that the recursion to $\POnone$ already satisfies the constraint due to the constraint $\lO$.
...
\begin{GRule}
  ...
  \GRgapfragDeco{$\POnone$}{O}{}
  \GRdecompTo
  \GRgapfragDeco{$\POnone{_{\text{,iloop}}}$}{O}{}
  \GRor
  \GRgapfragDeco{$\POnone{_{\text{,mloop}}}$}{O}{}
  \GRor
  \GRgapfragDeco[itype/.style={fix,shift={(-0.3,0)}},
...
\begin{equation}
\begin{GRule}
  \GRgapfragDeco{$\PfromOnone$}{fromO}{lO}
  \GRdecompTo
  ...
  \GRor        
  \GRgapfragDeco[ltype/.style=free]{$P_{\text{O}}$}{O}{}
  \GRconcat\GRdecwfrag[ltype/.style=fix]{$\WPnone$}
  %
  \GRnewrule
  \GRgapfragDeco{$\PfromMnone$}{fromM}{lO}     
  \GRdecompTo
...
\node (O) at (0,0) [shape=circle,draw] {O};
