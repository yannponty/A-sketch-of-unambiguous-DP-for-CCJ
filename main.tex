...
A \emph{band} is a subset $[i,j]\cup[k,l]$ of sequence positions, iff there is a base pair band, such that its outermost base pair is $(i,l)$ and its innermost base pair is $(k,l)$.
\end{definition}
...
represented by $P$. Proving the uniqueness of bdo (given our restrictions) would be the essential step to showing the uniqueness of the recursions.}
