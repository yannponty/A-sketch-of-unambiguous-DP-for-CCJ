...
fragments, where
\begin{enumerate}
\item $(i,i')$ spans the gap, i.e. $i'\in[k,l]$
...
\begin{GRule}
  %LHS
  \GRgapfragDeco[right arc/.style={dotted arc}]{$P_{\text{fromR,l*O}}$}{lO}
  \GRdecompTo
  %RHS
  \GRgapfragDeco[inner arc/.style={solid arc},ktype/.style=free]{}{lO}\GRseclabel{$P_{\text{M,l*O}}$}
...
\begin{equation}
\begin{GRule}
  \GRgapfragDeco[outer arc/.style={dotted arc}]{$P_{\text{fromO}}$}{lO}
  \GRdecompTo
  ...
  %
  \GRnewrule
  \GRgapfragDeco[inner arc/.style={dotted arc}]{$P_{\text{fromM}}$}{lO}     
  \GRdecompTo
  \GRgapfragDeco[right arc/.style={solid arc},ktype/.style=free]{}{lO}\GRseclabel{$P_{\text{R,l*O}}$}
  \GRconcatWBefore{k}\GRwfrag[itype/.style=fix]{$W\!P$}\GRrestorelast
\end{GRule}
\end{equation}
