...
Type & Helix classes && Subsets&\\ \midrule
...
We summarize in Table~\ref{tab:iso} the various accessible classes. An close inspection of the classes reveals two -- complete and unambiguous -- decompositions of the CCJ class in the following subsets of non-empty helices:
