...
We consider closed structures over regions $[i,l]$ (\CR) as structures that are decomposable into two \CGR-structures and recursive substructure due to
$$
\begin{GRule}
\Pdecomposition{}
\end{GRule}
$$
and where all occurring recursive substructure are \CR-structures; idea: CCJ-structures are the structures that can be decomposed into a sequence of \CR-structures and recursive substructures, which are CCJ-structures (compare $W$-rule, Eq.~\ref{eq:wrule})
